...
//  Sentinel
//
//  Created by Sailesh Suri on 2012-10-20.
...
@synthesize sportsArray = _sportsArray;
...
- (void)viewDidLoad
{
    ...
    NSError *error;
    _sportsArray = [NSJSONSerialization JSONObjectWithData:data options:kNilOptions error:&error];
