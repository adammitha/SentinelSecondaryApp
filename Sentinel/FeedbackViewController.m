...
- (void)viewDidLoad
{
    ...
    NSString *tempString = [NSString stringWithFormat:[NSString stringWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"description" ofType:@"html"] encoding:NSUTF8StringEncoding error:nil], [[NSBundle mainBundle] pathForResource:@"Sentinel Text Logo" ofType:@"png"]];
